...
void MConfigCommand::boardTypeToXml(const std::string  &boardType, XMLElement **parent)
{
...
void MConfigCommand::blockToXml(bool block, XMLElement **parent)
{
	return boardTextValueToXml(MPRINTER_BOARD_BLOCKED, MTools::toString(block), parent);
}

void MConfigCommand::userMessageToXml(const std::string &userMessage, XMLElement **parent)
{
	return boardTextValueToXml(MPRINTER_BOARD_CURRENT_MSG, userMessage, parent);
}

void MConfigCommand::bcdToXml(const Printers::BCDMode& bcdMode, const Printers::BCDTable& bcdTable, XMLElement **parent)
{
...
void MConfigCommand::printDirectionToXml(const Printers::PrinterDir &printDir, XMLElement **parent)
{
	return boardTextValueToXml(MPRINTER_BOARD_PRINT_DIR, printDir.toString(), parent);
}

void MConfigCommand::printInvertedToXml(bool printRotated, XMLElement **parent)
{
	return boardTextValueToXml(MPRINTER_BOARD_PRINT_INVERTED, MTools::toString(printRotated), parent);
}

void MConfigCommand::nozzlesToXml(const Printers::NozzlesCol &nozzlesCol, XMLElement **parent)
{
	return boardTextValueToXml(MPRINTER_BOARD_NOZZLES_COL, nozzlesCol.toString(), parent);
}

void MConfigCommand::shotModeToXml(const Printers::ShotMode &shotMode, XMLElement **parent)
{
	if (*parent != nullptr && std::strcmp((*parent)->Name(), MPRINTER_BOARD) == 0) {
...
void MConfigCommand::encoderToXml(const Printers::Encoder &encoder, XMLElement **parent)
{
	if (*parent != nullptr && std::strcmp((*parent)->Name(), MPRINTER_BOARD) == 0) {
...
void MConfigCommand::photocellToXml(const Printers::Photocell &photocell, XMLElement **parent)
{
	return boardTextValueToXml(MPRINTER_BOARD_PHOTOCELL, photocell.toString(), parent);
}

void MConfigCommand::propertiesToXml(const Printers::Board::propertyMap &properties, XMLElement **parent)
{
	if (*parent != nullptr && std::strcmp((*parent)->Name(), MPRINTER_BOARD) == 0) {
...
void MConfigCommand::cartridgeToXml(const Printers::Cartridge &cartridge, XMLElement **parent)
{
	if (*parent != nullptr && std::strcmp((*parent)->Name(), MPRINTER_BOARD) == 0) {
...
void MConfigCommand::inputsToXml(const std::vector<Printers::Input> &inputs, XMLElement **parent)
{
	if (*parent != nullptr && std::strcmp((*parent)->Name(), MPRINTER_BOARD) == 0) {
...
void MConfigCommand::outputsToXml(const std::vector<Macsa::Printers::Output> &outputs, XMLElement **parent)
{
	if (*parent != nullptr && std::strcmp((*parent)->Name(), MPRINTER_BOARD) == 0) {
...
void MConfigCommand::dateCodesToXml(const Macsa::Printers::DateCodes &dateCodes, XMLElement **parent)
{
	if (*parent != nullptr && std::strcmp((*parent)->Name(), MPRINTER_BOARD) == 0) {
...
void MConfigCommand::boardFromXml(const XMLElement *xBoard, Printers::Board &board) const
{
...
void MConfigCommand::bcdFromXml(const XMLElement *xBoard, Macsa::Printers::Board &board) const
{
	if (xBoard != nullptr) {
...
void MConfigCommand::shotModeFromXml(const XMLElement *xBoard, Macsa::Printers::Board &board) const
{
	if (xBoard != nullptr) {
...
void MConfigCommand::encoderFromXml(const XMLElement *xBoard, Macsa::Printers::Board &board) const
{
	if (xBoard != nullptr) {
...
void MConfigCommand::propertiesFromXml(const XMLElement *xBoard, Macsa::Printers::Board &board) const
{
	if (xBoard != nullptr) {
...
void MConfigCommand::cartridgeFromXml(const XMLElement *xBoard, Macsa::Printers::Board &board) const
{
	if (xBoard != nullptr) {
...
void MConfigCommand::inputsFromXml(const XMLElement *xBoard, Macsa::Printers::Board &board) const
{
	if (xBoard != nullptr) {
...
void MConfigCommand::outputsFromXml(const XMLElement *xBoard, Macsa::Printers::Board &board) const
{
	if (xBoard != nullptr) {
...
template<class T>
void MConfigCommand::dateCodesFormatedListToXml(const std::string &format, const std::vector<T> &dateCodesList, XMLElement **parent)
{
...
void MConfigCommand::boardTextValueToXml(const std::string &valueName, const std::string &value, XMLElement **parent)
{
	if (*parent != nullptr && std::strcmp((*parent)->Name(), MPRINTER_BOARD) == 0) {
