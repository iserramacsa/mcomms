...
void MMessageValues::userFieldsFromXml(const XMLElement *parent, Macsa::JetProtocol::userFieldsMap &map) const
{
...
void MMessageValues::datesFromXml(const XMLElement *parent, Macsa::JetProtocol::datesMap& map) const
{
...
void MMessageValues::countersFromXml(const XMLElement *parent, Macsa::JetProtocol::countersMap &map) const
{
...
//================		GET USER FIELDS		================//
MGetMessageValues::MGetMessageValues(Printers::TijPrinter &printer, const std::string &filename, const Macsa::JetProtocol::userFieldsMap &userFields) :
...
//================		SET USER FIELDS		================//
MSetMessageValues::MSetMessageValues(Printers::TijPrinter &printer, const std::string &filename, const Macsa::JetProtocol::userFieldsMap &userFields) :
...
MGetMessageDataSource::MGetMessageDataSource(Printers::TijPrinter &printer,
											 ...
											 const JetProtocol::userFieldsMap& userFields,
											 const JetProtocol::datesMap& dates,
											 const JetProtocol::countersMap& counters) :
