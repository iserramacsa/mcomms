	...
	namespace JetProtocol {
		...
		class JetConfigCommand : public JetCommand
		{
			...
			protected:
				...
				void loggerToXml(const Printers::JetPrinter& printer, tinyxml2::XMLElement **parent);
				void printerConnectionsToXml(const Printers::JetComms* comms, tinyxml2::XMLElement **parent);
				...
				void generalConfigFromXml(const tinyxml2::XMLElement *parent, Printers::JetPrinter& printer) const;
				void printerConnectionsFromXml(const tinyxml2::XMLElement *parent, Printers::JetComms& comms) const;
				...
				void dateCodesFromXml(const tinyxml2::XMLElement *xBoard, Printers::JetPrinter& printer) const;
